...
static constexpr uint8_t NUM_CAN_CHANNELS     = ::etl::make_span(::routing::canChannelIds).size();
static constexpr uint8_t NUM_FLEXRAY_CHANNELS = ::etl::make_span(::routing::frChannelIds).size();
