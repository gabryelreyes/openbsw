...
/* ThreadX user configuration for NUCLEO-F413ZH (Cortex-M4, 96 MHz). */
...
/* Timer thread stack - the default 1024 is too small when the timer
 * callback dispatches multiple runnables. */
